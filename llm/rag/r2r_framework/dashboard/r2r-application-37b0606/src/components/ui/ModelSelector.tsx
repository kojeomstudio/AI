...
const predefinedModels = [
  { value: 'ollama/gemma3:latest', label: 'ollama/gemma3:latest' },
  { value: 'ollama/deepseek-r1:latest', label: 'ollama/deepseek-r1:latest' },
  { value: 'ollama/qwen2.5-coder:latest', label: 'ollama/qwen2.5-coder:latest' },
];
